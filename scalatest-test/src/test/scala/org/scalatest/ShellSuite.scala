...
class ShellSpec extends FunSpec {

  it("test defaults") {

    // From default values
    org.scalatest.color should have (
      sym"colorPassed" (true),
      sym"durationsPassed" (false),
      sym"shortstacksPassed" (false),
      sym"fullstacksPassed" (false),
      sym"statsPassed" (false)
    )
    org.scalatest.durations should have (
      sym"colorPassed" (true),
      sym"durationsPassed" (true),
      sym"shortstacksPassed" (false),
      sym"fullstacksPassed" (false),
      sym"statsPassed" (false)
    )
    ...
    org.scalatest.stats should have (
      ...
      sym"shortstacksPassed" (false),
      sym"fullstacksPassed" (false),
      sym"statsPassed" (true)
    )
    org.scalatest.nocolor should have (
      sym"colorPassed" (false),
      sym"durationsPassed" (false),
      sym"shortstacksPassed" (false),
      sym"fullstacksPassed" (false),
      sym"statsPassed" (false)
